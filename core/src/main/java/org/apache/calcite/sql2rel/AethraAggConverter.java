 ...
 * </ul>
 */
class AethraAggConverter implements SqlVisitor<Void> {
  private final AethraSqlToRelConverter.Blackboard bb;
  ...
  private AethraAggConverter(AethraSqlToRelConverter.Blackboard bb,
   ...
   * @param bb     Blackboard
   */
  static AethraAggConverter create(AethraSqlToRelConverter.Blackboard bb) {
    return new AethraAggConverter(bb, ImmutableMap.of());
  }
  ...
  static AethraAggConverter create(AethraSqlToRelConverter.Blackboard bb,
    ...
    return new AethraAggConverter(bb, ImmutableMap.copyOf(nameMap)) {
   ...
   * {@link #create(AethraSqlToRelConverter.Blackboard, AggregatingSelectScope)}. */
